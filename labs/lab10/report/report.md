...
![Попытка удаления модулей ext4 и xfs](image/Screenshot_4.png){ #fig:004 width=70% }
...
![Загрузка модуля bluetooth](image/Screenshot_5.png){ #fig:005 width=70% }
...
![Информация о модуле bluetooth и его параметры](image/Screenshot_6.png){ #fig:006 width=70% }
...
![Проверка текущего ядра и списка доступных пакетов](image/Screenshot_7.png){ #fig:007 width=70% }
...
![Обновление ядра и системы](image/Screenshot_8.png){ #fig:008 width=70% }
...
![Проверка после обновления ядра](image/Screenshot_9.png){ #fig:009 width=70% }
