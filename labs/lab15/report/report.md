...
![Создание PV на /dev/sdc1](image/Screenshot_11.png){ #fig:011 width=70% }
...
![Расширение LV и файловой системы XFS](image/Screenshot_15.png){ #fig:015 width=70% }
...
![Итоговая проверка томов и файловой системы](image/Screenshot_16.png){ #fig:016 width=70% }
