...
![Демонстрация работы setgid и sticky-бита](image/02.png){ #fig:002 width=70% }
...
![Права ACL для каталогов](image/03.png){ #fig:003 width=70% }
...
![Создание файлов без ACL по умолчанию](image/04.png){ #fig:004 width=70% }
...
![Наследование ACL по умолчанию](image/05.png){ #fig:005 width=70% }
...
![Проверка доступа пользователем carol](image/06.png){ #fig:006 width=70% }
