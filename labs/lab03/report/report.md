...
![Рис 1.1 указываем имя](image/2.1.1.png){#fig:001 width=70%}
Рис 1.1 указываем имя

Настроим utf-8 в выводе сообщений git:
![Рис 1.2 настраиваем](image/2.1.2.png){#fig:002 width=70%}


![Название рисунка1](image/2.1.3.png){#fig:002 width=70%}
![Название рисунка1](image/2.1.4.png){#fig:002 width=70%}
